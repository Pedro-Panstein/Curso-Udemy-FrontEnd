...
const allNumbers = numbers.concat(otherNumbers).concat(item);
...
console.log(wall);
delete wall.model, delete wall.color, delete wall.material;
console.log(wall);
...
users.forEach((user) => {
  console.log(`Listando o usuário com forEach: ${user}`);
});
...
array.pop(); // remove o ultimo objeto do array
...
//shift remove o primeiro item da lista e o unshift adiciona um item ao inicio da lista
...
const arrayDaFrase = frase.split(" "); // split divide uma string em array

console.log(arrayDaFrase);

// 21 - join
const fraseDenovo = arrayDaFrase.join(" "); // join une um array em uma string
...
const someInfinita = (...args) => { // ... aceita argumentos infinitos
  let total = 0;
