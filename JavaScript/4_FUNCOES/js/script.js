...
function funcaoDentroDeFuncao() {
  minhaFuncaoEmVariavel();
}

funcaoDentroDeFuncao();
...
const arrowTeste = (n) => {
  if (n === 3) {
    ...
    console.log(`Seu numero não é igual a 3`);
  }
};
...
ten(100, 7);
console.log(ten(100, 7)); // usar o console log em recursões não funciona
